...
<template>
    ...
    <div class="my-bg">
        <div class="container">
            <div class="series-container fs-4">
                <span>CURRENT SERIES</span>
            </div>
            <div class="d-flex flex-wrap justify-content-center pt-3">
                <div class="col-md-3 col-lg-2" v-for="card in cardList">
                    <div>
                        <img :src="card.thumb" alt="">
                        <h5 class="text-white pt-2 pb-2">{{ card.series }}</h5>
                    </div>
                </div>
            </div>
            <div class="d-flex justify-content-center pb-3">
                <button class="my-btn text-center">LOAD MORE</button>
            </div>
        </div>
    </div>
